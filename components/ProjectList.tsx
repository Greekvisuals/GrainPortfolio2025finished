          ...
          >
            ...
            <div className="absolute inset-0 z-40 bg-[#050505]">
              <video
                ...
                muted
                playsInline
                preload="metadata" // only fetch metadata first
                poster={project.thumbnailUrl} // mobile fallback image
                className="w-full h-full object-cover opacity-80 group-hover:opacity-100 transition-opacity duration-700 ease-out"
              >
                {/* Mobile version */}
                <source
                  src={project.videoMobileUrl || project.videoUrl} // fallback to default if mobile version missing
                  type="video/mp4"
